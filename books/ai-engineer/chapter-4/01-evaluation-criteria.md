...
Verifying whether a statement is consistent with a given context can also be framed as  _textual entailment_, which is a long-standing NLP task.[4](https://learning.oreilly.com/library/view/ai-engineering/9781098166298/ch04.html#id1009)  Textual entailment is the task of determining the relationship between two statements. Given a premise (context), it determines which category a hypothesis (the output or part of the output) falls into:
...
Benchmarks for factual consistency include TruthfulQA. It comprises 817 questions that some humans would answer incorrectly due to a false belief or misconception. These questions span 38 categories, including health, law, finance, and politics. This benchmark comes with a specialized AI judge, GPT-judge, that was finetuned to automatically evaluate whether a response is factually consistent with the reference response.  [Table 1](../images/truthfulqa.jpg)  shows example questions and false answers generated by GPT-3.

![Table 1](../images/truthfulqa.jpg)
###### Table 1. Example questions from TruthfulQA.

[Figure 2](../images/performance-of-different-models.jpg)  shows the performance of several models on this benchmark, as shown in  [GPT-4’s technical report](https://oreil.ly/PSNna)  (2023). For comparison, the human expert baseline, as reported in the TruthfulQA paper, is 94%.
...
![Figure 2](../images/performance-of-different-models.jpg)
###### Figure 2. The performance of different models on TruthfulQA, as shown in GPT-4’s technical report.
